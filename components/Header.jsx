    ...
    <header className="sticky top-0 z-40 bg-white shadow-sm">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-yellow-400 to-yellow-600 flex items-center justify-center text-white font-bold text-lg">
            RI
          </div>
          <div>
            <div className="font-bold text-sm">Ravindra Iron Works</div>
            <div className="text-xs text-gray-600">The Iron People</div>
          </div>
        </Link>
      ...
      <div className={`md:hidden transition-all duration-200 ${isOpen ? 'max-h-96' : 'max-h-0 overflow-hidden'}`}>
        <nav className="border-t bg-white px-6 py-4 space-y-3" aria-label="Mobile navigation">
          <a href="#home" className="block py-2 hover:text-gold transition">Home</a>
          <a href="#about" className="block py-2 hover:text-gold transition">About</a>
